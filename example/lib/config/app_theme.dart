...
class AppTheme {
  ...
  static final ThemeData dark = ThemeData(
    brightness: Brightness.dark,
    // green
    primaryColor: const Color(0xFFBC9F5B),
    // light grey
    primaryColorLight: const Color(0xff969CAE),
    // dark blue
    ...
    secondaryHeaderColor: const Color(0xff616161),
    dialogBackgroundColor: const Color(0xff424242),
    indicatorColor: const Color(0xFFBC9F5B),
    hintColor: const Color(0x80ffffff),
    shadowColor: Colors.black.withOpacity(0.3),
    appBarTheme: const AppBarTheme(
      backgroundColor: Color(0xFF011423),
    ),
    buttonTheme: const ButtonThemeData(
      padding: EdgeInsets.only(left: 16, right: 16),
      shape: RoundedRectangleBorder(
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ButtonStyle(
        ...
        backgroundColor:
            MaterialStateProperty.all<Color>(const Color(0xFFBC9F5B)),
      ),
    ),
    ...
    textTheme: TextTheme(
      ...
      /// маленькие подписи, например рейтинг фильма
